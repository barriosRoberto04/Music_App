...
* **Búsqueda en Tiempo Real y Navegación de Artistas**:
  * Motor de búsqueda integrado en la interfaz que realiza consultas directas y actualizadas de contenido multimedia de YouTube.
  * **Filtro y Perfil de Artista**: Al realizar búsquedas, se permitirá navegar al perfil del artista respectivo.
  * **Pantalla de Detalle del Artista**: Al abrir el perfil del artista, la interfaz mostrará:
    * Nombre oficial del artista y su fotografía de perfil (obtenida dinámicamente desde YouTube).
    * Catálogo completo de todos sus álbumes disponibles.
  * **Navegación de Álbumes**: Al seleccionar un álbum específico, se desplegará el listado completo de canciones con opción a:
    * **Reproducción en Streaming**: Escuchar la canción de forma online directamente (sin descargar).
    * **Descarga Física**: Descargar la pista en formato MP3 de alta fidelidad para reproducción local offline.
